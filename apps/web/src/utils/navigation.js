...
const pointToSegmentDistanceMeters = (point, segmentStart, segmentEnd) => {
...
export const getDistanceToRouteMeters = (position, routePoints) => {
...
export const getNearestRoutePointIndex = (position, routePoints) => {
    if (routePoints.length === 0) {
        return 0;
    }
    let nearestIndex = 0;
...
export const getRemainingDistanceMeters = (position, routePoints) => {
    if (routePoints.length === 0) {
        return 0;
    }
...
export const estimateRemainingDurationSeconds = (remainingDistanceMeters, totalDistanceKm, totalDurationMinutes) => {
...
export const findUpcomingInstructionIndex = (position, instructions, startIndex) => {
...
export const toCoordinateInput = (coordinates) => {
