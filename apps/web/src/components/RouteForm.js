...
export const RouteForm = ({ origin, destination, tripType, transitDateTimeLocal, transitTimeType, profile, loading, locatingOrigin, onChange, onOpenProfile, onUseCurrentLocation, onSubmit }) => {
